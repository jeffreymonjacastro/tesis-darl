...
import subprocess
import sys
from extractor.config import HTML_EXTENSIONS, MARKDOWN_EXTENSIONS, PYTHON_DEPENDENCIES
...
def prepare_dependencies(ext: str, extraction_mode: str, install_mode: str) -> None:
    if ext in MARKDOWN_EXTENSIONS:
        offer_dependency_install(
            feature="Markdown AST extraction",
            module_names=["markdown_it"],
            fallback="raw Markdown text without an AST",
